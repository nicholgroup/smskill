...
USB and Ethernet VISA connections will be closed if the device is disconnected or rebooted.  **[smclose](smclose)** and **[smopen](smopen)** the device.
...
# DAC Errors #
Sometimes the DAC does not respond properly 
a **smadacinit** should usually clear things up