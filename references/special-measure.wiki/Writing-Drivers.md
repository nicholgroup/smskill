...
Adding new instruments consists of two parts: writing a [control function](#Control_Function) and specifying the instrument information in [\*smdata.inst\*](#smdata.inst), a struct array with the following fields:
